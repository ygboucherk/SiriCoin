_web3 = new Web3(new Web3.providers.HttpProvider("https://rpc-mainnet.maticvigil.com"));
...
async function mining() {
	try {
		...
		return await submitWork(_results);
	} catch (e) { return "Bad"; }
}
...
function addShare() {
	shares += 1;
	try {
		document.getElementById("miningStatus").innerHTML = "running - " + shares + " shares accepted";
	}
	catch (e) {
